...
namespace VideoGameCharacter.Services
{
    ...
    {
        //Adds a new character to the Character's table with the provided DTO information, stores it on the table and returns it as a CharacterResponse.
        ...
        public async Task<bool> UpdateCharacterAsync(int id, UpdateCharacterRequest character)
        {
            ...
            characterToUpdate.Role = character.Role.ToString();
